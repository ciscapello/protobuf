...
func (c *authServiceClient) Login(ctx context.Context, in *LoginReguest, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (UnimplementedAuthServiceServer) Login(context.Context, *LoginReguest) (*LoginResponse, error) {
...
func _AuthService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Login(ctx, req.(*LoginReguest))
	}
